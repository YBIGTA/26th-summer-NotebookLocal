...
import { Cog, Command, Cpu, Database, Sparkles, Wrench, Server } from "lucide-react";
...
const TAB_IDS = ["basic", "model", "QA", "command", "plus", "server", "advanced"] as const;
...
const icons: Record<TabId, JSX.Element> = {
  ...
  server: <Server className="tw-size-5" />,
